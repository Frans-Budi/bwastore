                ...
                @foreach ($carts as $cart)
                  <tr>
                    ...
                    <td style="width: 35%">
                      ...
                      <div class="product-subtitle">by {{ $cart->product->user->store_name }}a</div>
                    </td>
                    <td style="width: 35%">
        ...
        <form action="{{ route('checkout') }}" method="POST" enctype="multipart/form-data" id="locations">
          ...
          <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-md-4 mb-3">
              <div class="form-group">
                ...
                <select name="regencies_id" id="regencies_id" class="form-select" v-if="regencies" v-model="regencies_id">
          ...
          <div class="row" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-8 col-md-3">
              <button type="submit" class="btn btn-success btn-block w-100 mt-4 px-4">
                Checkout Now
              </button>
            </div>
          </div>
